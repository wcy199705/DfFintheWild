...
from train_Dataloader import FocalStackDDFFH5Reader
...
def main():
    ...
    parser.add_argument('--cpus',default=10,type=int,help='num_workers')
...
#DISP test add..
    ...
    train_dataset=FocalStackDDFFH5Reader(dataroot, stack_key="stack_train", disp_key="disp_train")
    valid_dataset=FocalStackDDFFH5Reader(dataroot, stack_key="stack_val", disp_key="disp_val")

    num_val=1318
    num_train=5269//batch_size
    avg_Loss=0.0
    avg_middle=0.0
    avg_DFF_1=0.0
    avg_DFF_2=0.0
