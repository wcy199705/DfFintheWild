...
*  The pretrained weight is trained by the synthetic dataset whose focal stacks consits of 10 images generated by our simulator.
*  Please refer the uploaded dataset(in folder 'ball')
...
* My model has still rooms between synthetic dataset generated by simulator and real datasets. Handling the parameters of our simulator will give you better results than ours. Please try it.
