...
* My model has still rooms between synthetic dataset generated by simulator and real datasets. Handling the parameters of my simulator will give you better results than mine. Please try it.
